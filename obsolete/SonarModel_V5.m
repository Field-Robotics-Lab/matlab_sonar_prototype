...
for k = 1:nBeams
    ...
    for i = 1:nRays
        ...
        thetaCurrent =  th(k); % should be th(k) but at 0 you get NaN, need 
                               % to make a condition because it is undefined at 0 to just make it a smal number;
        
        if (th(k)-thetaCurrent) == 0
            thetaCurrent = 0.0001;
        end
