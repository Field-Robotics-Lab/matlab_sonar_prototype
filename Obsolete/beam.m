...
% Beam Parameters
nBeams = 1;
th = linspace(-beamWidth,beamWidth,nRays); % vector of look angles
...
% Beamforming Loop
    ...
    for i = 1:nRays
        ...
        P_t_modified = sum(beamPatternCurrent'.*P_t); %p_t is nFreqxnBeams, and beamPatternCurrent is nBeamsx1
